...
namespace OgvPlayer
{
    public class FmodTheoraStream
    {
        ...
        public static void Init()
        {
            ...
            {
                Log.Editor.WriteWarning("Problem initialising the audio part of the video player.{0}. Error: {1}", result, exception.Message);
            }
            if (result != RESULT.OK)
            {
                Log.Editor.WriteWarning("Problem initialising the audio part of the video player.{0}. No exceptions", result);
            }
