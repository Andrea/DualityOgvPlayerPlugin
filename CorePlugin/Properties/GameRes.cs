...
namespace GameRes
{
	public static class Data {
		...
		public static Duality.ContentRef<ScriptingPlugin.Resources.FSharpScript> VideoPlayer_FSharpScript { get { return Duality.ContentProvider.RequestContent<ScriptingPlugin.Resources.FSharpScript>(@"Data\VideoPlayer.FSharpScript.res"); }}
		public static Duality.ContentRef<Duality.Resources.Scene> VideoScene_Scene { get { return Duality.ContentProvider.RequestContent<Duality.Resources.Scene>(@"Data\VideoScene.Scene.res"); }}
		public static void LoadAll() {
			...
			VideoPlayer_FSharpScript.MakeAvailable();
			VideoScene_Scene.MakeAvailable();
		}
	}
